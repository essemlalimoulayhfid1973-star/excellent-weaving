...
export default function Products() {
  ...
  // تحميل المنتجات من LocalStorage (نفس المنتجات اللي فـ AdminPanel)
  useEffect(() => {
    const storedProducts = localStorage.getItem('tisaj_products');
    if (storedProducts) {
      setProducts(JSON.parse(storedProducts));
    } else {
      // منتجات افتراضية بسيطة
      setProducts([
              ...
              <div style={{ padding: '20px' }}>
                ...
                <div style={{
                  ...
                  <span style={{
                    ...
                    {typeof product.price === 'number' ? product.price.toLocaleString() : product.price} {t('products.price')}
                  </span>
                  <button
